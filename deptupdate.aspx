<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deptupdate.aspx.cs" Inherits="Employee_Management_Systum.deptupdate" %>
        ...
        <div class="form">
            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="Loc" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:Label runat="server"  ID="err2" Visible="false" ForeColor="Red"></asp:Label>
                        </div>
                       
                        <div>
                        <asp:Button runat="server"  ID="Submit" CssClass="btn btn-primary" Text="Update Department" OnClick="Submit_Click"   />
