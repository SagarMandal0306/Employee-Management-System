<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_dept.aspx.cs" Inherits="Employee_Management_Systum.add_dept" %>
...
<body>
   ...
   <div class="body">
    ...
    <form id="form1" runat="server">
        <div class="form">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Deprtment Name</label>
                        ...
                        <asp:Button runat="server" ID="Display" CssClass="btn btn-secondary" Text="Show Table" PostBackUrl="~/department.aspx" />
                        </div>
        </div>
    </form>
